...
const SampleCfg SIG = {"root/Tt1M2000.root","mrecoil_isolated_toplikes_rec_missE_cut","dh_sig","pdf_sig",0.000098746};
...
static void PlotBestWindow(double L, double R, double bestZ)
{
    ...
    c1.SaveAs("bestWindow_invMass2000.png");
    ...
    c2.SaveAs("bestWindow_ratio2000.png");

    // --- also save both canvases to a ROOT file so they can be reused interactively
    TFile fout("bestWindow_canvases2000.root", "RECREATE");
...
// -----------------------------------------------------------------------------
// main scan
void full_analysis_with_plot2000() {
