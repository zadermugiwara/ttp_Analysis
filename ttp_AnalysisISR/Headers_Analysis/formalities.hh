...
void cutflow(int size, string CF[], int cf[], double CrossSection, double Luminosity, ofstream *outfile)
{
  ...
  for(unsigned i = 0; i < ( size ); i++)
	  cout    << "\t" << i << " " << CF[i] << "\t\t" << cf[i]<< "\t\t   " << (cf[i]*CrossSection*pow(10, -12)*Luminosity)/(pow(cf[0], 1))         << endl;
  cout     << "      ----------------------------"               << endl;
  ...
  *outfile     << "   ---------------------\n\n";
  *outfile     << "      ---------------------------------------------\n";
  *outfile     << "\t    Cut          # of evts         weighted\n";
  *outfile     << "      ---------------------------------------------\n";
  for(unsigned i = 0; i < ( size ); i++)
	  *outfile    << "\t" << i << " " << CF[i] << "\t" << cf[i] << "\t\t   " << (cf[i]*CrossSection*pow(10, -12)*Luminosity)/(pow(cf[0], 1))<< "\n";
  *outfile     << "      ----------------------------------------\n";
