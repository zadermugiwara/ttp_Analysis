...
TCanvas* deltaTPbPhi = new TCanvas("deltaTPbPhi", "deltaTPbPhi", 600, 400);
...
mass1200->GetYaxis()->SetRangeUser(0,0.54);
...
f1200.GetObject("tPt", pt1200);
f1600.GetObject("tPt", pt1600);
f2000.GetObject("tPt", pt2000);
f2400.GetObject("tPt", pt2400);
...
pt1200->GetYaxis()->SetRangeUser(0,0.08);
...
deltaRWD1WD21200->GetYaxis()->SetRangeUser(0,0.094);
...
leg3->SetTextFont(42);
leg3->Draw();
deltaRWD1WD2->Print("deltaRWD1WD2.pdf");
//histo1->Rebin(5);
//histo2->Rebin(5);
//histo3->Rebin(5);
//histo4->Rebin(5);*/
...
deltaRWD1b1200->GetYaxis()->SetRangeUser(0,0.125);
...
leg4->SetTextFont(42);
leg4->Draw();
deltaRWD1b->Print("deltaRWD1b.pdf");
//histo1->Rebin(5);
//histo2->Rebin(5);
//histo3->Rebin(5);
//histo4->Rebin(5);*/

TH1F* deltaTPbPhi1200,* deltaTPbPhi1600,* deltaTPbPhi2000,* deltaTPbPhi2400;
TLegend *leg5 = new TLegend(0.15,0.65,0.5,0.85);
f1200.GetObject("deltaTPbPhi", deltaTPbPhi1200);
f1600.GetObject("deltaTPbPhi", deltaTPbPhi1600);
f2000.GetObject("deltaTPbPhi", deltaTPbPhi2000);
f2400.GetObject("deltaTPbPhi", deltaTPbPhi2400);

deltaTPbPhi1200->SetDirectory(0);
deltaTPbPhi1600->SetDirectory(0);
deltaTPbPhi2000->SetDirectory(0);
deltaTPbPhi2400->SetDirectory(0);



//pt1200->Draw();
deltaTPbPhi->cd();
deltaTPbPhi1200->Scale(1.0/deltaTPbPhi1200->Integral());
deltaTPbPhi1200->GetYaxis()->SetRangeUser(0,0.15);
//deltaTPbPhi1200->GetYaxis()->SetRangeUser(0,0.54);
deltaTPbPhi1200->SetLineColor(1);
deltaTPbPhi1200->Draw("HISTE");
deltaTPbPhi1600->Scale(1.0/deltaTPbPhi1600->Integral());
deltaTPbPhi1600->SetLineColor(2);
deltaTPbPhi1600->Draw("HISTE SAME");
deltaTPbPhi2000->Scale(1.0/deltaTPbPhi2000->Integral());
deltaTPbPhi2000->SetLineColor(3);
deltaTPbPhi2000->Draw("HISTE SAME");
deltaTPbPhi2400->Scale(1.0/deltaTPbPhi2400->Integral());
deltaTPbPhi2400->SetLineColor(4);
deltaTPbPhi2400->Draw("HISTE SAME");
leg5->AddEntry(deltaTPbPhi1200,"m_{T}=1200 GeV, #Gamma_{T}=22.3178 GeV","l");
leg5->AddEntry(deltaTPbPhi1600,"m_{T}=1600 GeV, #Gamma_{T}=53.271 GeV","l");
leg5->AddEntry(deltaTPbPhi2000,"m_{T}=2000 GeV, #Gamma_{T}=104.38 GeV","l");
leg5->AddEntry(deltaTPbPhi2400,"m_{T}=2400 GeV, #Gamma_{T}=180.682 GeV","l");
leg5->SetBorderSize(0);
leg5->SetFillColor(0);
leg5->SetTextFont(42);
leg5->Draw();
deltaTPbPhi->Print("deltaTPbPhi.pdf");
//histo1->Rebin(5);
//histo2->Rebin(5);
//histo3->Rebin(5);
//histo4->Rebin(5);*/
