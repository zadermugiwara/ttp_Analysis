...
const SampleCfg SIG = {"root/Tt1M1200.root","mrecoil_isolated_toplikes_rec_missE_cut","dh_sig","pdf_sig",0.00024646};
...
static void PlotBestWindow(double L, double R, double bestZ)
{
    ...
    c1.SaveAs("bestWindow_invMass1200.png");
    ...
    c2.SaveAs("bestWindow_ratio1200.png");

    // --- also save both canvases to a ROOT file so they can be reused interactively
    TFile fout("bestWindow_canvases1200.root", "RECREATE");
...
// -----------------------------------------------------------------------------
// main scan
void full_analysis_with_plot1200() {
