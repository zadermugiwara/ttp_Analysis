...
# ------------------ CONFIG ------------------
DEFAULT_SH_PATH   = "/home/higinio/Documentos/ASE/Analysis_Programs/Histograms.sh"
DEFAULT_OUT_DIR   = "/home/higinio/Documentos/ASE/Resultados"
...
DEFAULT_ASE_DIR       = os.path.abspath(os.path.join(os.path.dirname(__file__), os.pardir))
# --------------------------------------------
